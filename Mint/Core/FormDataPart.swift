...
public struct FormDataPart {
    ...
    fileprivate let type: FormDataPart.PartType
    ...
    public enum PartType {
        ...
        case png
        case jpg
        case custom(Mint.ContentType)
        
        var contentType: Mint.ContentType {
            switch self {
            case .data:
                return .bin
            case .png:
    ...
    public init(type: FormDataPart.PartType = .data, data: Data, parameterName: String, filename: String? = nil) {
        self.type = type
        self.data = data
